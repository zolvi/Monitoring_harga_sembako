...
<div class="row page-titles">
  ...
  <div class="col-md-7 align-self-center text-right">
    <div class="d-flex justify-content-end align-items-center">
      <ol class="breadcrumb">
        <li class="breadcrumb-item">Kategri</a></li>
...
<div class="row page-titles">
  <div class="col-sm-12">
    <div class="box" style="border:1px solid #d2d6de;">
        {!! Form::open([
                'action' => ['KategoriController@store'],
                'files' => true
            ])
        !!}
        ...
        <div class="box-body" style="margin:10px;">
          ...
          <a class="btn btn-warning " href="{{ route('kategori.index') }}" style="width:100px;"><i class="fa fa-btn fa-back"></i>Cancel</a>
      	</div>
