...
<div class="row page-titles">
  ...
  <div class="col-md-7 align-self-center text-right">
    <div class="d-flex justify-content-end align-items-center">
      ...
      <a href="{{ route('kategori.create') }}" class="btn btn-info d-lg-block m-l-15"><i class="fa fa-plus-circle"></i> Create New</a>
    </div>
  </div>
</div>
<div class="row page-titles">
                  ...
                  <tr>
                      ...
                      <td class="actions">
                            <ul class="list-inline" style="margin-bottom:0px;">
                                <li><a href="{{ route('kategori.edit', $item->id) }}" title="{{ trans('app.edit_title') }}" class="btn waves-effect waves-light btn-outline-success btn-xs"><i class="fa fa-pencil"></i></a></li>
                                <li>
                                    {!! Form::open([
                                        'class'=>'delete',
                                        'url'  => route('kategori.destroy', $item->id),
                                        'method' => 'DELETE',
                                        ])
                                    !!}
